...
class BIP32Tests: QuickSpec {
  class TestVector {
    ...
    init(_ path: String, _ seed: String, _ extendedPrivateKeyString: String, _ extendedPublicKeyString: String) {
      self.path = path
      self.seed = Data(hex: seed)
      self.privateKey = extendedPrivateKeyString
      self.publicKey = extendedPublicKeyString
    }
  }
    ...
    lazy var testVectors: [TestVector] = {
      let vector: [TestVector] = [
        ...
        TestVector("m/0'/1/2'/2",
                   "000102030405060708090a0b0c0d0e0f",
                   "xprvA2JDeKCSNNZky6uBCviVfJSKyQ1mDYahRjijr5idH2WwLsEd4Hsb2Tyh8RfQMuPh7f7RtyzTtdrbdqqsunu5Mm3wDvUAKRHSC34sJ7in334",
                   "xpub6FHa3pjLCk84BayeJxFW2SP4XRrFd1JYnxeLeU8EqN3vDfZmbqBqaGJAyiLjTAwm6ZLRQUMv1ZACTj37sR62cfN7fe5JnJ7dh8zL4fiyLHV"),
        TestVector("m/0'/1/2'/2/1000000000",
                   "000102030405060708090a0b0c0d0e0f",
