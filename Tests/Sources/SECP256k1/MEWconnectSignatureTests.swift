  ...
  override func spec() {
    describe("MEWconnect signature test") {
      ...
      it("Should sign data correctly") {
        ...
        guard let signedDataLeadingV = testData.unsafeSign(key: testKey, leadingV: true), let signedDataTrailingV = testData.unsafeSign(key: testKey, leadingV: false)
        else {
      ...
      it("Should have correct length") {
        ...
        let signature = data?.unsafeSign(key: testKey, leadingV: false)
