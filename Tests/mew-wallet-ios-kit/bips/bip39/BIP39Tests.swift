...
fileprivate struct TestVector: Sendable {
...
@Suite("BIP39 Tests")
fileprivate struct BIP39Tests {
  @Test("Test Bech39 valid cases", arguments: TestVector.valid)
  func valid(vector: TestVector) async throws {
    ...
    #expect(entropyBIP39.mnemonic == vector.mnemonic)
    #expect(mnemonicBIP39.entropy == vector.entropy)
    if case .japanese = vector.language {
      ...
      #expect(entropySeedPassword == vector.seed)
      #expect(entropySeedNormalizedPassword == vector.seed)
      #expect(mnemonicSeedPassword == vector.seed)
      #expect(mnemonicSeedNormalizedPassword == vector.seed)
    } else {
      ...
      #expect(entropySeed == vector.seed)
      #expect(mnemonicSeed == vector.seed)
    }
  }
}
