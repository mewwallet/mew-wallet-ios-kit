...
extension Bitcoin._Encoding {
  /// A custom low-level binary buffer used by `Bitcoin.Encoder` for encoding Bitcoin transaction structures.
  ///
  ...
  internal final class Storage {
    ...
    func append(storage other: Bitcoin._Encoding.Storage) {
      defer {
    ...
    func append<D: DataProtocol>(_ value: D) {
