...
extension Data {
  ...
  package func secp256k1RecoverableSign(privateKey: Data, extraEntropy: Bool = false, context: OpaquePointer/*secp256k1_context*/) -> secp256k1_ecdsa_recoverable_signature? {
  ...
  package func secp256k1RecoverPublicKey(hash: Data, context: OpaquePointer/*secp256k1_context*/) -> Data? {
